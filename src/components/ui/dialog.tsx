  ...
  return (
    <>
      ...
      <div
        ref={ref}
        className={cn(
          "fixed left-[50%] top-[50%] z-50 flex w-full max-w-4xl translate-x-[-50%] translate-y-[-50%] flex-col gap-4 border border-border/40 bg-background p-6 shadow-lg duration-200 dark:border-white/[0.06] sm:rounded-lg",
          className
        )}
        {...props}
      >
